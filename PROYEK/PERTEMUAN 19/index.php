...
if ($isHome) {
    ...
    switch ($halaman) {
        // AUTH & PUBLIC
        case "loginuser":
            include "auth/loginuser.php";
            break;
        case "registerpeserta":
            include "auth/registrasipeserta.php";
            break;
        ...
        case "edituser":
            ...
            break;
        case "lihatuser":
            include "pages/user/lihat.php";
            break;

        // KELOLA CV DIGITAL
        case "cvdigital":
            include "pages/cvdigital/index.php";
            break;
        case "tambahcv":
            include "pages/cvdigital/tambah.php";
            break;
        case "editcv":
            include "pages/cvdigital/edit.php";
            break;
        case "lihatcv":
            include "pages/cvdigital/lihat.php";
            break;
    }
    echo '</div></div></div>';
}
