...
<div id="heroCarousel" class="carousel slide" data-ride="carousel" data-interval="5000">
    ...
    <div class="carousel-inner">
        ...
        <div class="carousel-item active">
            <div style="height:90vh; background:url('assets/image/slider/slider1.jpg?v=1') center center/cover no-repeat; position:relative;">
        ...
        <div class="carousel-item">
            <div style="height:90vh; background:url('assets/image/slider/slider2.jpg?v=2') center center/cover no-repeat; position:relative;">
                <div style="position:absolute; inset:0; background:rgba(0,0,0,.55);"></div>
                <div class="d-flex flex-column justify-content-center align-items-center text-center text-white h-100 px-3" style="position:relative;">
        ...
        <!-- SLIDE 3 -->
        <div class="carousel-item">
            <div style="height:90vh; background:url('assets/image/slider/slider3.jpg?v=3') center center/cover no-repeat; position:relative;">
                <div style="position:absolute; inset:0; background:rgba(0,0,0,.55);"></div>
                <div class="d-flex flex-column justify-content-center align-items-center text-center text-white h-100 px-3" style="position:relative;">
...
<section class="py-5 bg-white">
    <div class="container text-center">
        ...
        <div class="row mt-4">
            <div class="col-md-4">
                <div class="card shadow-sm p-3"><i class="fas fa-edit fa-2x text-primary mb-2"></i>
                    <h6>Input Biodata</h6><small>Variabel & Tipe Data</small>
                </div>
            </div>
            <div class="col-md-4">
                <div class="card shadow-sm p-3"><i class="fas fa-check fa-2x text-success mb-2"></i>
                    <h6>Validasi</h6><small>Percabangan & Function</small>
                </div>
            </div>
            <div class="col-md-4">
                <div class="card shadow-sm p-3"><i class="fas fa-file-alt fa-2x text-warning mb-2"></i>
                    <h6>Output CV</h6><small>Array & Perulangan</small>
                </div>
            </div>
        </div>
    </div>
