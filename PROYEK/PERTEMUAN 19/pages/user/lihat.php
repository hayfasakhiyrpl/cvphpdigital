...
if (!$view) {
    echo '<div class="alert alert-danger m-3">User ID ' . $id . ' tidak ditemukan</div>';
    return;
}
            ...
            <div class="col-md-8">
                ...
                <table class="table table-sm">
                    <tr>
                        ...
                        <td>: <?= htmlspecialchars($view['username'] ?? '-') ?></td>
                    </tr>
                    <tr>
                        <td>Password</td>
                        <td>: <?= htmlspecialchars($view['password'] ?? '-') ?> <small>(plain untuk pembelajaran)</small></td>
                    </tr>
                    <tr>
                        <td>Nama</td>
                        <td>: <?= htmlspecialchars($view['nama'] ?? '-') ?></td>
                    </tr>
                    <tr>
                        <td>Role</td>
                        <td>: <?= htmlspecialchars($view['role'] ?? '-') ?></td>
                    </tr>
                    <tr>
                        <td>Email</td>
                    ...
                    <tr>
                        <td>Tanggal Buat</td>
                        <td>: <?= htmlspecialchars($view['tanggal_buat'] ?? '-') ?></td>
                    </tr>
                    <tr>
                        <td>Foto File</td>
                        <td>: <code><?= htmlspecialchars($foto) ?></code></td>
                    </tr>
                </table>
            </div>
